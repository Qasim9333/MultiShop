                        ...
                        <div id="product-carousel" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner bg-light">
                                <div className="carousel-item active">
                                    <img className="w-100 h-100" src="./images/product-1.jpg" alt='' />
                                </div>
                                <div className="carousel-item">
                                    <img className="w-100 h-100" src="./images/product-2.jpg" alt="" />
                                </div>
                                <div className="carousel-item">
                                    <img className="w-100 h-100" src="./images/product-3.jpg" alt="" />
                                </div>
                                <div className="carousel-item">
                                    <img className="w-100 h-100" src="./images/product-4.jpg" alt="" />
                                </div>
                            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            ...
                                            <div className="media mb-4">
                                                <img src="./images/user.jpg" alt="" className="img-fluid mr-3 mt-1" style={{ width: '45px' }} />
                            ...
                            <div class='item'>
                                <div className="product-item bg-light">
                                    <div className="product-img position-relative overflow-hidden">
                                        ...
                                        <div className="product-action">
                                            <a className="btn btn-outline-dark btn-square" href="/"><i className="fa fa-shopping-cart"></i></a>
                                            <a className="btn btn-outline-dark btn-square" href="/</div>"><i className="far fa-heart"></i></a>
                                            <a className="btn btn-outline-dark btn-square" href="/"><i className="fa fa-sync-alt"></i></a>
                                            <a className="btn btn-outline-dark btn-square" href="/"><i className="fa fa-search"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div className="product-item bg-light">
                                    <div className="product-img position-relative overflow-hidden">
                                        ...
                                        <div className="product-action">
                                            ...
                                            <a className="btn btn-outline-dark btn-square" href="/</div>"><i className="far fa-heart"></i></a>
                                            <a className="btn btn-outline-dark btn-square" href="/"><i className="fa fa-sync-alt"></i></a>
                                            <a className="btn btn-outline-dark btn-square" href="/</div>"><i className="fa fa-search"></i></a>
                                        </div>
                                    </div>
                                    <div className="text-center py-4">
                                        <a className="h6 text-decoration-none text-truncate" href="/">Product Name Goes Here</a>
